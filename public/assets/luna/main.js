!function (w) {
    ...
    // 中文：将后端 pay_check 与前端图标进行映射
    // English: Map backend pay_check slugs to frontend SVG icons
    // 中文：Epusdt 图标（TRC20），用于展示加密支付方式
    // English: Epusdt (TRC20) icon for crypto payment display
    ...
    //页面操作
    // 中文：根据支付标识渲染图标，支持 tokenpay-* 前缀显示加密货币图标
    // English: Render icon based on pay_check; handle tokenpay-* as crypto icon
