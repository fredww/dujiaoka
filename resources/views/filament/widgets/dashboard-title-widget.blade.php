...
<div class="dashboard-title card bg-primary">
    <div class="card-body">
        <div class="text-center">
            <img class="avatar img-circle shadow mt-1" src="/vendor/dujiaoka-admin/images/logo.jpg" alt="Logo">
            ...
            <div class="text-center mb-1">
                ...
                <div class="links">
                    ...
                    <a href="//shang.qq.com/wpa/qunwpa?idkey=37b6b06f7c941dae20dcd5784088905d6461064d7f33478692f0c4215546cee0" id="qq-group-link" target="_blank">
                        <img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="QQ" title="{{ __('dujiaoka.join_qq_group') }}">
                    </a>
    ...
    <!-- 中文注释：该片段复制旧 Dashboard 标题，并适配 Filament Widget -->
</div>